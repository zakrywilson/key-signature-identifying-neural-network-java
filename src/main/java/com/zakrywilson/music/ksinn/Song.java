...
class Song {
    ...
    /**
     * Default constructor. Creates a new random series of notes (song) based on a randomly
     * generated key.
     */
    Song() {
        random = new Random();
    ...
    double[] getFrequencies() {
        ...
        for (byte note : this.song) { frequencies[note]++; }
        return frequencies;
    }

    /**
     * Takes the key of the song and assigns that index to 1 while keeping the rest of the indexes
     * at 0.
     *
